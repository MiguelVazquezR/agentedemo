...
<template>
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                Los códigos de recuperación te devuelven el acceso si pierdes el
                dispositivo con 2FA. Guárdalos en un gestor de contraseñas.
            </CardDescription>
        </CardHeader>
        <CardContent>
            <div
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        Cada código de recuperación sirve una sola vez para
                        entrar a tu cuenta y se elimina después de usarlo. Si
                        necesitas más, pulsa
