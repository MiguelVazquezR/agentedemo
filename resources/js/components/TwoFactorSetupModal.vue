...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'La verificación en dos pasos ya está activa. Escanea el código QR o escribe la clave de configuración en tu aplicación de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de activar la verificación en dos pasos, escanea el código QR o escribe la clave de configuración en tu aplicación de autenticación',
        buttonText: 'Continuar',
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >o escribe el código manualmente</span
                            >
                        </div>
